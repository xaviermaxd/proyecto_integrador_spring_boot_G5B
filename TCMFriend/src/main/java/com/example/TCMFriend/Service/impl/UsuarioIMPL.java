...
public class UsuarioIMPL implements UsuarioService {
	...
	public String updateUsuario(int id, UsuarioDTO usuarioDTO) {
	    	Usuario usuarioid = usuarioRepo.findById(id);
	    	usuarioid.setEmail(usuarioDTO.getEmail());
	    	usuarioid.setNombre(usuarioDTO.getNombre());
	    	usuarioid.setPassword(this.passwordEncoder.encode(usuarioDTO.getPassword()));
	    	usuarioid.setCiclo(usuarioDTO.getCiclo());
	    	usuarioid.setCarrera(usuarioDTO.getCarrera());
	    	usuarioid.setDescripcion(usuarioDTO.getDescripcion());
	    	
	    	usuarioRepo.save(usuarioid);
	    	return usuarioid.getNombre();
	}
